...
fltime = input('Type in any of the time shown above to book your flight[format hh:mm:ss]: ')

times = (str(ti), str(ti1), str(ti2))
if fltime in times:
    print('You have chose the time - ', fltime)
    print('Your flight will now be booked', airline, fltime)
else:
    ...
    if flch == 'Y' or 'y':
        ...
        print('Okay you wil now be exited..')
        exit()
